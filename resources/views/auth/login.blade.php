        ...
        <div id="page-wrapper">
				...
				<div class="logbox">
				  ...
				  {!! csrf_field() !!}
					<h1>Login</h1>
					<hr class="colorgraph">
					<input name="email" type="email" placeholder="Enter your email" required="required"  class="input pass"/>
					...
					<div>
						...
						<a href="signup" id="" style="text-decoration: none;">
                        <input type="button" value="Sign Up!" class="inputButton registerBtn"/></a>
					</div>	
